...
def parse_args():
    ...
    # parser.add_argument('--name', dest='model_name', type=str, default='test', help='model_name')
...
if __name__ == "__main__":
    ...
    gpu_ids = [int(gpu) for gpu in args.gpu_id.split(',')]
    if len(gpu_ids) == 0:
        cfg.CUDA = False
    elif len(gpu_ids) == 1:
        cfg.GPU_ID = [gpu_ids[0]]
    ...
    ix2vec = dataset.ix2vec
    algo = \
        trainer(output_dir, dataloader, n_words, ix2word, dataset, ix2vec)
